...
<head>
    ...
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/backend/css/fonts/css/font-awesome.min.css" rel="stylesheet">
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/backend/jsjquery.min.js"></script>
