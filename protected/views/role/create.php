...
<!--                        <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>                        </p>-->
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="role_name" class="form-control col-md-7 col-xs-12" data-msg="Role Name required" data-validate-length-range="6" data-validate-words="2" name="role_name" placeholder="Role Name" required="required" type="text" value="<?php echo $model->role_name ? $model->role_name: '';  ?>">
                            </div>
                        </div>
                        <div class="item form-group">
