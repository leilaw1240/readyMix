...
class UserRoles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('role_name', 'length', 'max'=>60),
			array('permissions, created_date, updated_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, role_name, permissions, status, created_by, created_date, updated_by, updated_date', 'safe', 'on'=>'search'),
		);
	}
